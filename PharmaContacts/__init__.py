...
class PharmaContacts(MoleculeContainer):
    __slots__ = ()

    def find_contacts(self, other: 'PharmaContacts', index: int = 0, other_index: int = 0) -> \
...
__all__ = ['PharmaContacts', 'Hydrophobic',  'Salts', 'HydrogenDonor', 'HydrogenAcceptor', 'HalogenDonor',
